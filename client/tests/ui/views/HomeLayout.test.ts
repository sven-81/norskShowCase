...
import Home from '@/ui/layouts/HomeLayout.vue'
...
describe('HomeLayout.vue', () => {
    ...
    describe('if the user is not logged in', () => {
        ...
        it('displays the welcome text', () => {
            ...
            wrapper.vm.$nextTick(() => {
                expect(wrapper.find('p.home').exists()).toBe(true)
                expect(wrapper.text()).toContain('Willkommen zum Vokabeltrainer für Norwegisch!')
            })
        })
    })
